                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="index.php">Ruangan</a>
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    <ol class="breadcrumb mb-4">
                        <h1 class="mt-4 mx-auto p4">Ruangan Hotel</h1>
                    </ol>
                            ...
                            foreach($data as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        |
                                        <a href="index.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus ruangan ini?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
