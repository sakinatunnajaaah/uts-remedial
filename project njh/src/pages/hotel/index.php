                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="../reservasi/index.php">Jadwal</a>
                                        </nav>
                                    </div>
                                </nav>
                            </div>                            
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    <ol class="breadcrumb mb-4">
                        <h1 class="mt-4 mx-auto p4">Daftar Hotel</h1>
                    </ol>
                            ...
                            foreach($data as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        |
                                        <a href="index.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus hotel ini?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
                    <a href="create.php" class="btn btn-primary">Tambah</a><br><br>
