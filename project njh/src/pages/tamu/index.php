            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    <ol class="breadcrumb mb-4">
                        <h1 class="mt-4 mx-auto p4">Tamu Hotel</h1>
                    </ol>
                            ...
                            foreach($data as $row) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        |
                                        <a href="index.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus tamu ini?')">Hapus</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
