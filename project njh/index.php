    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="src/pages/authentication/login.php">Login</a>
                                    <a class="nav-link" href="src/pages/authentication/register.php">Register</a>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="src/pages/hotel/index.php">Hotel</a>
                                        </nav>
                                    </div>
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="src/pages/tamu/index.php">Tamu</a>
                                            <a class="nav-link" href="src/pages/ruangan/index.php">Ruangan</a>
                                            <a class="nav-link" href="src/pages/reservasi/index.php">Jadwal</a>
                                        </nav>
                                    </div>
                                </nav>
                            </div>                            
            ...
            <div id="layoutSidenav_content">
                <main>
                    <img src="src/assets/img/reservasi.jpg" alt="Deskripsi Gambar" />
                </main>
